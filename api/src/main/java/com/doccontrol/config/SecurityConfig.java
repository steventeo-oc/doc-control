...
public class SecurityConfig {
    ...
    // CSRF is disabled for Sprint 1: internal-only API, session cookie is
    // SameSite=Lax (application.yml). Revisit with a proper token scheme when
    // the web frontend is wired up.
    @Bean
